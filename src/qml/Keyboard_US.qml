...
ColumnLayout {
  ...
  RowLayout {
    spacing: 0
    property var keycodes: ["TLDE", "AE01", "AE02", "AE03", "AE04", "AE05", "AE06",
  ...
  RowLayout {
    ...
    property var keycodes: ["AD01", "AD02", "AD03", "AD04", "AD05", "AD06",
  ...
  RowLayout {
    ...
    property var keycodes: ["AC01", "AC02", "AC03", "AC04", "AC05", "AC06",
  ...
  RowLayout {
    ...
    property var keycodes: ["AB01", "AB02", "AB03", "AB04", "AB05", "AB06",
                            "AB07", "AB08", "AB09", "AB10"]
    Repeater {
      model: parent.keycodes
      delegate: Key {
